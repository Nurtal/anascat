...
def plot_clusters(image, tab_coords, labels, patch_size:int, image_name:str):
    """
...
def generate_mask(image, tab_coords, labels, patch_size:int, image_name:str, target_label_list:list):
    """
    Affiche une image avec les patches colorés selon leur cluster.
